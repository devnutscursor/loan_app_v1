...
export const calculateMatchScore = (requirement, document) => {
  ...
  // console.log('Requirement category:', reqCategory);
  // console.log('Requirement document type:', reqType);
  // Exact category match is highest priority for general matches
  if (docCategory === reqCategory && docType === reqType) {
    score += 100;
  }
...
export const assignDocumentsToRequirements = (requirements, documents) => {
  ...
  //           docCategory === 'insurance' || docName.includes('homeowner');
  ...
  //           docName.includes('k-1') || docName.includes('p&l');

  //       case 'scheduleC':
  //         return docName.includes('schedule') || docName.includes('profit') ||
  //           docName.includes('loss') || docName.includes('corp');
