                      ...
                      {tabs.map((tab) => {
                        ...
                        return (
                          <button
                            ...
                            className={`
                              relative flex items-center justify-center py-2.5 px-4 rounded-lg text-sm font-medium whitespace-nowrap
                              transition-all duration-200 ease-in-out mx-1 first:ml-0 last:mr-0
                              ${isActive 
                          ...
                          >
                            <span className={`flex items-center ${isActive ? 'scale-105' : ''}`}>
                              <span className={`mr-2 text-base ${isActive ? 'opacity-100' : 'opacity-70'}`}>{tab.icon}</span>
                              {tab.label}
                            </span>
                            {/* No bottom border for selected tab */}
                          </button>
                        );
                      })}
                    </nav>
