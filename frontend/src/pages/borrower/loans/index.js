            ...
            {loading ? (
              ...
              <>
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                  ...
                  <div className="mt-4 sm:mt-0 flex items-center justify-center sm:justify-start flex-wrap gap-3 sm:gap-4">
                    <button 
                      ...
                      disabled={loading}
                      className="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all w-full sm:w-auto"
                    >
                ...
                {loansList.length > 0 ? (
                  ...
                  // No loans view - now inside the main layout
                  <NoLoansView />
                )}
              </>
            )}
