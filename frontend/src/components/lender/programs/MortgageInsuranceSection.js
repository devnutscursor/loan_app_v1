 ...
 */
const MortgageInsuranceSection = ({ formData, onChange, isLoading }) => {
                    ...
                    <tr key={index}>
                      <td className="whitespace-nowrap px-3 py-2 text-xs">
                        <div className="relative">
                          ...
                          <input
                            type="number"
                            className="w-20 pl-6 py-1 border border-gray-300 rounded-md bg-gray-50"
                            value={tier.minLTV}
                  ...
                  {formData.privateMortgageInsurance.map((tier, index) => (
                    <tr key={index}>
                      <td className="whitespace-nowrap px-3 py-2 text-xs">
                        <input
                          type="number"
                          className="w-16 px-1 py-1 border border-gray-300 rounded-md bg-gray-50"
                          value={tier.minLTV}
                          onChange={(e) => handlePMIChange(index, 'minLTV', e.target.value)}
                          step="0.01"
                          min="0"
