...
const LoansTable = ({
  ...
  return (
    <>
      {/* Desktop Table View */}
      <div className="hidden lg:block bg-gray-50 shadow overflow-hidden rounded-lg border border-gray-200 overflow-x-auto">
        {/* Table Header */}
              ...
              <div className="p-4">
                ...
                <div className="mt-4 pt-3 border-t border-gray-100">
                  <Link
                    ...
                    className="flex items-center justify-center text-blue-600 hover:text-blue-800 font-medium text-sm hover:bg-blue-50 rounded-lg py-2 transition-all duration-200"
                  >
                    <ExternalLink className="h-4 w-4 mr-1" />
                    <span>View Details</span>
                  </Link>
