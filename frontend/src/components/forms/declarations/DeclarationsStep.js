 ...
 */
const DeclarationsStep = ({ formData, handleChange, validateStep, nextStep, prevStep, errors = {} }) => {
  ...
  const getTabIcon = (tabName) => {
    ...
    if (tabName === 'declarations') {
      ...
      isComplete = formData.declarations && 
      ...
      isComplete = formData.demographics && 
      ...
      <div className="flex space-x-2 mb-6">
        ...
        >
          <div className="flex items-center">
            ...
            {getTabIcon('declarations') && <span className="ml-2">{getTabIcon('declarations')}</span>}
          </div>
        </button>
        <button
          type="button"
        ...
        >
          <div className="flex items-center">
            ...
            {getTabIcon('demographics') && <span className="ml-2">{getTabIcon('demographics')}</span>}
          </div>
        </button>
      </div>
