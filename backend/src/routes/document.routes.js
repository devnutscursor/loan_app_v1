...
router.post('/debug-upload', uploadWithErrorHandling.single('file', 'debug'), (req, res) => {
  try {
    // Log request details
...
// Upload a document
router.post('/upload', uploadWithErrorHandling.single('file', 'documents'), documentController.uploadDocument);
